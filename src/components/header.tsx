    ...
    <header className="w-full px-4 md:px-8 py-4 md:py-6">
      <div className="max-w-7xl mx-auto  flex items-center bg-[#FFFFFF2B] sm:bg-transparent justify-between gap-4  rounded-[90px] sm:rounded-none">
        ...
        <nav className="hidden sm:flex items-center gap-6 flex-2 justify-between ">
          ...
          <button className="text-white text-xs sm:text-sm rounded-[90px] py-2 md:py-3 px-3 md:px-6 bg-[linear-gradient(181.71deg,#373737_-39.78%,#FF9B7D_-8.23%,#FF3E00_106.05%)] whitespace-nowrap hover:opacity-90 transition">
            Connect Wallet
          </button>
        </nav>
      ...
      >
        <div className="bg-[#FFFFFF2B] backdrop-blur-2xl w-full rounded-lg p-3 flex flex-col gap-3 text-white">
          ...
          <button
            onClick={() => setIsOpen(false)}
            className="w-full text-center text-white text-sm rounded-[20px] py-2 bg-[linear-gradient(181.71deg,#373737_-39.78%,#FF9B7D_-8.23%,#FF3E00_106.05%)]"
          >
            Connect Wallet
          </button>
        </div>
